     ...
     <div class="row">
       ...
       <div class="col-lg-12">
         <div class="card">
           ...
           <?php echo form_open('home/proseseditkendaraandinas?id=' . $kend['idk'], 'class="form-horizontal"') ?>
           <div class="card-body">
             <div class="row">
               <div class="col-md-6">
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="id_aset"
                     value="<?= isset($kend) ? $kend['id_assets'] : id_aset() ?>" disabled readonly>
                 </div>
               </div>
               <?php if (isset($kend)) { ?>
               <div class="col-md-6">
             ...
             <div class="row">
               <div class="col-md-6">
                 <div class="form-group">
                   <label>Merk</label>
                   <input type="text" class="form-control" name="merk" value="<?= isset($kend) ? $kend['merk'] : ""; ?>"
                     required>
                 </div>
               </div>
               <div class="col-md-6">
             ...
             <div class="row">
               <div class="col-md-12">
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="tipe" value="<?= isset($kend) ? $kend['tipe'] : ""; ?>"
                     required>
                 </div>
               </div>
             </div>
               ...
               <div class="col-md-6">
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control pilihtanggal" name="tgl_stnk"
                     value="<?= isset($kend) ? date('d-m-Y', strtotime($kend['masa_berlaku_stnk'])) : ""; ?>" required>
                 </div>
               </div>
