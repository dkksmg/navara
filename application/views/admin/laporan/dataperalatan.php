           ...
           <div class="card-header">
             ...
             <div class="row">
               <div class="col-md-3">
                 ...
                 <?php if ($bulan == 'all') { ?>
                 <a href="<?= site_url('laporan/export_excel_peralatan?tahun=' . $tahun) ?>" class="btn btn-sm btn-warning"><i
                     class="fa-solid fa-file-excel"></i>
                   Export
                   Excel</a>
                 <?php }else{ ?>
                  <a href="<?= site_url('laporan/export_excel_peralatan_bulan?tahun=' . $tahun.'&bulan='.$bulan) ?>" class="btn btn-sm btn-warning"><i
                     class="fa-solid fa-file-excel"></i>
                   Export
                   Excel</a>
                 <?php  }; };?>
               ...
               <table class="table table-bordered table-striped example" width="100%">
                 <thead>
                   <tr>
                     ...
                     <th class="text-center" rowspan="2">Jenis Peralatan</th>
