                     ...
                     <tr>
                       ...
                       <td class="text-center">
                         <a onclick="deleteConfirm('<?= site_url('home/hapusrbbm?id=' . ($value['id_bbm']) . '&idkend=' . ($value['id_kendaraan'])) ?>')"
                           ...
                           title="Hapus Riwayat BBM <?= $kend['no_polisi'] ?>"><i class="fas fa-trash"></i></a>
                   ...
                   <tbody>
                     ...
                     <tr>
                       ...
                       <td class="text-center">
                         ...
                         <?php else : ?>
                         <p data-toggle="modal" width="30%" data-target="#strukModal2<?php echo $no ?>">
                           - </p>
                         <?php endif ?>
                       </td>
                       <td class="text-center" width="15%">
         ...
         <div class="modal-body">
           <center>
             <img src="<?= base_url('assets/upload/struk_bbm/' . $value['struk_bbm'] . '') ?>" alt="Foto Struk BBM"
               class="img-responsive" width="80%" height="auto">
           </center>
         </div>
