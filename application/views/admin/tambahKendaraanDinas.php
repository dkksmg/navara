...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> Tambah Kendaraan Dinas <small>NAVARA</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header" style="background-color:#ff7970;">
                <h3 style="font-weight:bold;">Tambah Kendaraan Dinas </h3>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="idassets" value="<?=isset($kend)?$kend['id_assets']:"";?>">
                      </div>
                    </div> 
                    <?php if (isset($kend)) { ?>
                      <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="jeniskendaraan">
                            <option <?=isset($kend)&&$kend['jenis']=='Sedan'?"selected":"";?> >Sedan</option>
                            <option <?=isset($kend)&&$kend['jenis']=='SUV'?"selected":"";?> >SUV</option>
                            <option <?=isset($kend)&&$kend['jenis']=='MPV'?"selected":"";?> >MPV</option>
                            <option <?=isset($kend)&&$kend['jenis']=='Ambulan'?"selected":"";?> >Ambulan</option>
                            <option <?=isset($kend)&&$kend['jenis']=='Sepeda Motor'?"selected":"";?> >Sepeda Motor</option>
                          </select>
                      </div>
                    </div> 
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="jenisbb"> 
                            <option <?=isset($kend)&&$kend['jenis_bb']=='Bensin'?"selected":"";?> >Bensin</option>
                            <option <?=isset($kend)&&$kend['jenis_bb']=='Solar'?"selected":"";?> >Solar</option>
                          </select>
                      </div>
                    </div> 
                    <div class="col-md-6">
