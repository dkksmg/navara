            ...
            <div class="card">
              ...
              <div class="card-body">
                <table  class="table table-bordered table-striped example" width="100%"> 
                  ...
                  <tbody>
                      <?php $no=1; if ($rs!='') { foreach ($rs as $value) { ?>
                        <tr>
                          <td><?=$no++;?></td>
                          <td></td>
                          ...
                          <td><img width="40%" src="<?=base_url('assets/foto_servis/'.$value['foto_servis'].'')?>" ></td>
                          <td><img width="40%" src="<?=base_url('assets/foto_servis/'.$value['foto_nota'].'')?>" ></td>
                        </tr>
                      <?php }} ?>
                  </tbody>
                </table>
