            ...
            <div class="card">
              ...
              <div class="card-body">
                <table  class="table table-bordered table-striped example">
                  ...
                  <tbody>
                    <?php $no=1; if ($rk!='') { foreach ($rk as $value) { ?>
                      <tr>
                        <td><?=$no++;?></td>
                        ...
                        <td><?=$value['kondisi']?></td>                        
                        <td><img width="70%" src="<?=base_url('assets/file_kendaraan/'.$value['foto_tampak_depan'].'')?>" ></td>
                        <td><img width="70%" src="<?=base_url('assets/file_kendaraan/'.$value['foto_tampak_kanan'].'')?>" ></td>
                        <td><img width="70%" src="<?=base_url('assets/file_kendaraan/'.$value['foto_tampak_kiri'].'')?>" ></td>
                        <td><img width="70%" src="<?=base_url('assets/file_kendaraan/'.$value['foto_tampak_blakang'].'')?>" ></td>
                      </tr>
                    <?php }} ?>
                  </tbody>
                </table>
