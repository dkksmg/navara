        ...
        if (!empty($_FILES['depan']['name'])&&!empty($_FILES['blkg']['name'])&&!empty($_FILES['kiri']['name'])&&!empty($_FILES['kanan']['name'])) {
            $simpan = $this->home_m->tambahriwayatkendaraan($nama_dpn,$nama_blkg,$nama_kiri,$nama_kanan,$idk);
                if ($simpan) {
                    ...
                    if (isset($nama_dpn)) { unlink('./assets/file_kendaraan/'.$nama_dpn); }                            
                    if (isset($nama_blkg)) { unlink('./assets/file_kendaraan/'.$nama_blkg); } 
                    if (isset($nama_kiri)) { unlink('./assets/file_kendaraan/'.$nama_kiri); } 
                    if (isset($nama_kanan)) { unlink('./assets/file_kendaraan/'.$nama_kanan); } 
        ...
        if(!empty($_FILES['nota']['name'])){
            ...
            if (!empty($_FILES['foto']['name'])&&!empty($_FILES['nota']['name'])) {
                ...
                if ($simpan) {
                    ...
                    redirect('pemakai/riwayatservis');            
                }else{
                    $this->session->set_flashdata('danger','Tambah Riwayat Service Kendaraan gagal');
                    $data['post'] = $this->input->post();
                }  
            }else{
                  if (isset($nama_dpn)) { unlink('./assets/foto_servis/'.$namafoto); }
